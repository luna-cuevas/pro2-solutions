...
const contact = () => {
  return (
    <div className='h-fit flex flex-wrap w-screen overflow-hidden'>
      <svg className='-z-10 md:min-h-screen absolute w-screen' xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" xmlnssvgjs="http://svgjs.com/svgjs" width="1440" height="560" preserveAspectRatio="none" viewBox="0 0 1440 560">
